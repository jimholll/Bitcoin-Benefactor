...
class CoinNode: SKSpriteNode {
    class func coin(location: CGPoint) -> CoinNode {
//        let sprite = CoinNode(imageNamed:"coin.png")
        let sprite = CoinNode(texture: CoinTexture, size: CGSize(width: 640, height: 640))
